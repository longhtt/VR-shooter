...
// TODO
//	1) eye separation: does stereopsis off fix this?
//	2) fix headset tracking: rotation causes movement (is center of head correct?)
//	3) support hand tracking: location, orientation, and button
...
Toggler		hmdTrack("HMD Track", true, 400, 13, 14);
